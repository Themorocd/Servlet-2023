...
public class enviodatos extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Disco> listcacompra = (ArrayList<Disco>) sesion.getAttribute("listacompra");
        ...
        String sql1 = "INSERT INTO pedidos (idUser,fechaPedido) value('"+id+"','"+formateodate+"')";
        ...
        for (Disco elem : listcacompra) {
            iddisco = elem.getIddisco();
            cantidad = elem.getCantdestacados();
            preciounidad = elem.getPrecio();
            BBDD.BD.altadetallespedido(idPedido,iddisco,cantidad,preciounidad);
        }
        listcacompra.clear();
        sesion.invalidate();
